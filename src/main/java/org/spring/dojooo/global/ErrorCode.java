...
public enum ErrorCode {
    ...
    NOT_USER_EQUALS_CURRENTUSER("로그인한 유저와 요청한 유저가 다릅니다", 403),
    ...
    //팔로워 팔로잉 관련
    FOLLOW_DUPLICATED("이미 팔로우한 사용자 입니다",409),
    FOLLOW_INVALID_REQUEST("자기 자신은 팔로우 할 수 없습니다",400),
    FOLLOW_NOT_FOUND("팔로우 관계를 찾을 수 없습니다.", 404);
